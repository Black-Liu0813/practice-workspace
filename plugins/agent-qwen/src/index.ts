// Agent plugin for Qwen — API-based agent with CLI wrapper
...
const BIN_PATH = join(process.env.PRACTICE_WORKSPACE_ROOT || process.cwd(), "bin", "qwen-chat");

function createQwenAgent() {
  return {
    name: "qwen",
    processName: "qwen-chat",
