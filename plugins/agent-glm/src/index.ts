// Agent plugin for GLM — API-based agent with CLI wrapper
...
const BIN_PATH = join(process.env.PRACTICE_WORKSPACE_ROOT || process.cwd(), "bin", "glm-chat");

function createGlmAgent() {
  return {
    name: "glm",
    processName: "glm-chat",
